...
- bus asincrono: si manifesta un handshake tra master e slave senza tenere conto dei tempi, il bus si adatta a seconda delle velocità dei dispositivi **
### Arbitraggio del bus
...
- l'arbitro centralizzato è integrato nel chip della CPU che se si rompe è un macello
- in quello decentralizzato non c'è un arbitro dove ogni dispositivo ha una sua priorità 

### Interrupt handling
è una interruzione che la CPU riceve una volta che un dispositivo ha finito e gli dice che ha finito

quando la cpu riceve una interrupt deve sapere come rispondere all'interno di un vettore 
